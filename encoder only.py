...
saving_dir = 'D:\\NING - spindle\\Spindle_by_Graphical_Features\\eventRelated_12_12_2017\\average_over_channels\\'
...
#        for ii in range(tfcs.data.shape[0]):
#            plt.close('all')
#            fig,ax = plt.subplots(figsize=(12,5))
#            im = ax.imshow(tfcs.data[ii,:,:,:].mean(0),origin='lower',aspect='auto',extent=[0,3000,8,20],
#                           vmin=0,vmax=1e-10)
